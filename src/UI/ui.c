...
void ui_BEGIN_screen_init(void)
{
    ...
    lv_img_set_src(ui_toppic, &ui_img_wizee_logo_02_120x30_png);
    lv_obj_set_width(ui_toppic, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_toppic, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_size(ui_toppic, 120, 30);
    lv_obj_set_pos(ui_toppic, 180, 0);
    ...
    lv_img_set_src(ui_dowmpic, &ui_img_1614516011);
    lv_obj_set_width(ui_dowmpic, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_dowmpic, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_size(ui_dowmpic, 140, 17);
    lv_obj_set_pos(ui_dowmpic, 170, 142);
...
void ui_MENU_screen_init(void)
{
    ...
    lv_obj_set_style_bg_img_src(ui_MENU, &ui_img_480x272_r043_png, LV_PART_MAIN | LV_STATE_DEFAULT);
