...
lv_obj_t *ui_Screen1;
lv_obj_t *ui_Header;
lv_obj_t *ui_SatInfoPanel;
lv_obj_t *ui_LabelSatCount;
lv_obj_t *ui_SatIcon;
...
lv_obj_t *ui_Screen2;
lv_obj_t *ui_WifiFormPanel;
lv_obj_t *ui_LabelWifiSettings;
lv_obj_t *ui_PanelWIfiSettings;
lv_obj_t *ui_DropdownSSID;
void ui_event_TextAreaWifiPassword( lv_event_t * e);
lv_obj_t *ui_TextAreaWifiPassword;
lv_obj_t *ui_PanelWIfiSettingsButtons;
void ui_event_ButtonCancelWifi( lv_event_t * e);
lv_obj_t *ui_ButtonCancelWifi;
lv_obj_t *ui_LabelCancelWifi;
void ui_event_ButtonSaveWifi( lv_event_t * e);
lv_obj_t *ui_ButtonSaveWifi;
lv_obj_t *ui_LabelSaveWifi;
...
lv_anim_set_values(&PropertyAnimation_0, 184, 87 );
...
lv_anim_set_user_data(&PropertyAnimation_0, PropertyAnimation_0_user_data);
lv_anim_set_custom_exec_cb(&PropertyAnimation_0, _ui_anim_callback_set_y );
lv_anim_set_values(&PropertyAnimation_0, 86, 500 );
lv_anim_set_path_cb( &PropertyAnimation_0, lv_anim_path_linear);
lv_anim_set_delay( &PropertyAnimation_0, delay + 0 );
lv_anim_set_deleted_cb( &PropertyAnimation_0, _ui_anim_callback_free_user_data );
lv_anim_set_playback_time(&PropertyAnimation_0, 0);
...
if ( event_code == LV_EVENT_FOCUSED) {
      SlideKeyboardUp_Animation(ui_Keyboard1, 0);
}
}
void ui_event_ButtonCancelWifi( lv_event_t * e) {
    lv_event_code_t event_code = lv_event_get_code(e);lv_obj_t * target = lv_event_get_target(e);
